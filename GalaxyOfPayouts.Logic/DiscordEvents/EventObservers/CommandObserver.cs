...
{
    public class CommandObserver : IObserver<SocketMessage>
    {
        private readonly GOPContext _db;
        private readonly IDisposable _unsubscriber;

        public CommandObserver(GOPContext db, IObservable<SocketMessage> provider)
        {
            _db = db;
        ...
        public void OnNext(SocketMessage message)
        {
            ...
            responder.SetResponseBehavior(new CommandBehavior(_db, message));
            responder.Respond();
        }
